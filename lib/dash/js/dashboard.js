...
$(function() {
    ...
    //Sparkline charts
    $('#sparkline-1').sparkline(cdata.myvalues1, {
        type: 'line',
        lineColor: '#92c1dc',
        fillColor: "#ebf4f9",
        height: '50',
    ...
    $('#sparkline-2').sparkline(cdata.myvalues2, {
        type: 'line',
        lineColor: '#92c1dc',
        fillColor: "#ebf4f9",
        height: '50',
    ...
    $('#sparkline-3').sparkline(cdata.myvalues3, {
        type: 'line',
        lineColor: '#92c1dc',
        fillColor: "#ebf4f9",
        height: '50',
