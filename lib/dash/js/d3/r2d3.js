...
var DIMENSION_LONGFORM = {
    ...
    year_built: {
        "en": "year built",
        "pt": "year built",
        "ru": "Ð³Ð¾Ð´ Ð¿Ð¾ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸",
        "zh-Hant": "å»ºæˆå¹´ä»½",
        "zh-Hans": "å»ºæˆå¹´ä»½",
        "fr": "construction",
        "ar": "Ø³Ù†Ø© Ø§Ù„Ø¨Ù†Ø§Ø¡",
        "es": "aÃ±o contrucciÃ³n",
        "it": "anno costruzione",
        "tr": "year built",
    ...
    price_per_sqft: {
        ...
        "pt": "price per meter",
        "ru": "Ñ†ÐµÐ½Ð° Ð·Ð° mÂ²",
        "zh-Hant": "æ¯å¹³æ–¹å…¬å°ºåƒ¹æ ¼",
        "zh-Hans": "æ¯å¹³æ–¹å…¬å°ºåƒ¹æ ¼",
        "fr": "prix par mÃ¨tre",
        "ar": "Ø³Ø¹Ø± Ø§Ù„Ù‚Ø¯Ù… Ø§Ù„Ù…Ø±Ø¨Ù‘Ø¹",
...
var testAccuracyText = function(LANG) {
    switch (LANG) {
        case 'ru':
            return 'Ñ‚Ð¾Ñ‡Ð½Ð¾ÑÑ‚ÑŒ Ñ€ÐµÐ·ÑƒÐ»ÑŒÑ‚Ð°Ñ‚Ð¾Ð² Ð½Ð° Ñ‚ÐµÑÑ‚Ð¾Ð²Ð¾Ð¹ Ð²Ñ‹Ð±Ð¾Ñ€ÐºÐµ'
        case 'fr':
            return 'prÃ©cision sur les donnÃ©es de test'
        case 'ar':
            return 'Ø¯Ù‚Ø© Ø§Ù„Ø§Ø®ØªØ¨Ø§Ø±'
        case 'es':
            return "precisiÃ³n prueba"
        case 'it':
...
var trainingAccuracyText = function(LANG) {
    switch (LANG) {
        case 'ru':
            return 'Ñ‚Ð¾Ñ‡Ð½Ð¾ÑÑ‚ÑŒ Ñ€ÐµÐ·ÑƒÐ»ÑŒÑ‚Ð°Ñ‚Ð¾Ð² Ð½Ð° Ð¾Ð±ÑƒÑ‡Ð°ÑŽÑ‰ÐµÐ¹ Ð²Ñ‹Ð±Ð¾Ñ€ÐºÐµ'
        case 'fr':
            return 'prÃ©cision sur les donnÃ©es dâ€™apprentissage'
        case 'ar':
            return 'Ø¯Ù‚Ø© Ø§Ù„ØªØ¯Ø±ÙŠØ¨'
        case 'es':
            return 'precisiÃ³n entrenamiento'
        case 'it':
...
var UNIT_CONVERSION = function(value, unit, lang) {
    ...
    switch (lang) {
        case 'ru':
            if (output_unit === 'per mÂ²') {
                output_unit = 'Ð·Ð° mÂ²';
            }
            break;
        case 'fr':
            if (output_unit === 'par mÂ²') {
                output_unit = 'Ð·Ð° mÂ²';
            }
            break;
        case 'es':
            if (output_unit === 'por mÂ²') {
                output_unit = 'Ð·Ð° mÂ²';
            }
            break;
        case 'it':
            if (output_unit === 'al mÂ²') {
                output_unit = 'Ð·Ð° mÂ²';
            }
            break;
        case 'ar':
            if (output_unit === 'Ø¨Ø§Ù„Ù‚Ø¯Ù… Ø§Ù„Ù…Ø±Ø¨Ø¹') {
                output_unit = 'Ð·Ð° mÂ²';
            }
            break;
    }
